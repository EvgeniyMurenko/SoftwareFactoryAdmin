        ...
        <div class="col-md-8">
            ...
            <table class="document-table2 other-font2">
                ...
                <tr>
                    ...
                    <td>앱과 같이 설계서를 받아서 작업하는 작업이 아닌 경우 소프트웨어는 100% 완벽하게 검수 완료할 수 없습니다...<br />
                        모든 상황에서 완벽히 동작되는 소프트웨어는 단 기간에 만들어질 수 없다는 것을 의미 합니다. 따라서 계약된 기간내에 95% 이상 완성된 상태를 완료 상태로 규정합니다.<br />
                        나머지 부분은 상황에 따라 보증 기간을 아래와 같이 적용하고 있으며 이 기간 동안에 발견하지 못한 버그나 SOFAC에서 보증해야 될 부분이 발생되면 보증 수리해 드립니다.<br />
                        (단, 보증 기간내에 신규하드웨어 또는 신규O/S 또는 고객의 상황 변경에 따른 내용을 보증 내용으로 볼 수 없습니다.)
                    </td>
                    <td>검수 완료 후<br />
                        모든 소스는 고객의 서버에 설치되며 소스코드 전체도 고객에게 즉시 이전 됩니다.</td>
                </tr>
                <tr>
                    <td>유지보수정책</td>
            ...
            <table class="document-table2 other-font2">
                ...
                <tr>
                    <td>비밀유지<br />
                        보장</td>
                    <td>SoFac 과 협의가 시작되는 시점부터 업무 종료 시점 까지 모든 내용은 절대 비밀 유지를 기본으로 합니다. 따라서 고객의 어떤 아이디어나 기술적인 정보를 SoFAC이 고객으로 부터 취득하여도 다른 고객들에게 전달되거나 공유하지 않습니다.</td>
                    <td></td>
                </tr>
