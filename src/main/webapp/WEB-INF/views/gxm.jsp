    ...
    <div class="row pt40">
        <div class="col-md-8">
            ...
            <p>대부분의 소프트웨어 개발 회사들은 많은 프로그래머들 중에 논리적인 사고와 작업 방법에 대한 안목이 있는 핵심 개발자들이 한명씩 있습니다.<br />
                그리고 대부분의 작업은 이들의 업무 집중도에 따라 퀄리티나 작업 시간이 결정되는 경우가 대부분이며 이들이 퇴사할 경우 그들이 개발한 소프트웨어의 유지보수등에 문제가 생기는 경우가 많습니다.</p>

            <p>GXM공법은 일부 개발자들에게 집중되어 있는 핵심역량을 모듈화 하고 분산하며 집단지성에 의해서 퀄리티를 유지하여 일부 인력에게 스트레스가 집중되는 것을 막고 시스템에 의해서 관리되게 하는 모든 체계를 말합니다.</p>

            <p>GXM에서는 현존하는 기술들을 대부분 확보하고 있으며 그것을 분산개발이 가능하도록 하는 모듈화 개발기법과 조합기법들을 연구 개발되어 실무에 적용되어 있으며 이것은 시간과 공간 그리의 언어소통의 문제들을 극복하여 다국적 분산 개발이 가능하게 하는 시스템 입니다.</p>
