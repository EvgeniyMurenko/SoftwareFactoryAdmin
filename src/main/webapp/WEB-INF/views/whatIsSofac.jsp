...
<section class="container content mb40">
    <div class="row pt40">
        <div class="col-md-8">
            ...
            <p>스마트폰 이전 시대까지 소프트웨어 개발이라는 분야는 하이테크 산업이었습니다.<br />그러나 스마트폰이 출현하고 SNS 시대가 되면서 모든 비즈니스는 클라우드 가상공간에서 이루어지는 시대가 되었습니다.</p>
            <p>따라서 많은 사람들이 새로운 사업을 시작하거나 기존의 중소기업들이 예전 방식의 IT조직을 운영하기가 어려워졌습니다.</p>
            <p>기술을 모르고 아이디어만 가진 사람들에게는 편안한 기술 지원과 지속적이고 안정적인 서비스를 제공하며 IT조직의 운영이 고비용 저효율의 문제로 고민하시는 기업들의 개발 운영 서비스 대행은 이 시대가 필요로 하는 사업입니다.</p>
            ...
            <p>소프트웨어팩토리는 이러한 문제점을 해결 하기 위하여 지금 시대에 필요한 대부분의 기술은 이미 확보 하여 무상으로 제공하는 것을 원칙으로 하고 있으며</p>
            <p>다국적 개발자들의 활용으로 비용절감과 다양한 분야의 개발 업무를 수행 가능하게 하였습니다.</p>
            <p>또한 수 많은 고객을 동시에 수용할 수 있도록 자동화된 공정과 병렬화된 개발방법을 통하여 고객별로 다른 서비스를 대량으로 동시간에 제공할 수 있는 공장형 소프트웨어 개발 대행 기업입니다.</p>
            <p>소프트웨어 팩토리는 한국의 ㈜굿앤굿 재무설계 법인이 주체가 되고 미국의 IT기업가 러시아, 우크라이나, 베트남등의 기업 및 우수한 대학들과 교류하여 개발에 필요한 인재를 양성하고 저 비용 고 퀄리티의 새로운 소프트웨어 개발 서비스 개념을 적용한 새로운 개념의 소프트웨어 회사 입니다.</p>
            <p>또한 재무설계 법인의 특성상 자금 및 법률 행정 지원과 더불어 소프트웨어가 동시에 지원이 되어야 기업이 성장할 수 있다는 새로운 시대적 요구에 따라 좋은 아이디어와 사업의 의지가 있는 스타트업 사업의 종합 지원도 가능한 새로운 개념의 소프트웨어 개발 지원 기업 입니다.</p>
        </div>
    </div>
</section>
<!-- #End Content -->
