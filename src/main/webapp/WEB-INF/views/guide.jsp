...
<section class="container content mb40">
    ...
    <div class="row pt40">
        <div class="col-md-8">
            ...
            <div class="row mb30">
                <div class="col-md-12"><a data-fancybox="gallery" href="resources/newIndexPage/images/shema4.jpg"><img src="resources/newIndexPage/images/shema4.jpg" alt="" class="img-responsive" /></a></div>
            </div>
