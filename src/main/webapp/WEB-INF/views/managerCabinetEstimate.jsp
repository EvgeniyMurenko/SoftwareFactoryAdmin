    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid content">
            ...
            <table class="table table-striped">
                <thead>
                <tr>
                    <th class="hidden-xs text-center">Estimate Id</th>
                    <th class="hidden-xs text-center">Date</th>
                    <%--     <th class="text-center">프로젝트</th>--%>
                    <th class="text-center">Price request</th>
                    <th class="text-center">Question request</th>
                ...
                %>
                    <tr class="unread checked">
                        <td class="hidden-xs text-center" ><a href="<%out.print("/manager-cabinet/estimate-respond/" + estimate.getId()+"/");%>"><% out.print(estimate.getEstimateGeneratedId()); %></a></td>
                        <td class="hidden-xs text-center"><%out.print(estimate.getDateRequest());%></td>
                        <td class="hidden-xs text-center"><% if (estimate.isPriceRequest()) out.print("yes"); else out.print("no"); %></td>
                        <td class="text-center"><% if (estimate.isQuestionRequest()) out.print("yes"); else out.print("no"); %></td>
                        <td class="hidden-xs text-center"><% if (estimate.isRespond()) out.print("checked"); else out.print("unchecked"); %></td>
                    </tr>
